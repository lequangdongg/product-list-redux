        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-lg-2">
              ...
              <ul>
                <li>
                  <a href="http://localhost:3000/">Store Delivery</a>
                </li>
                <li>
                  <a href="http://localhost:3000/">Online Delivery</a>
                </li>
                <li>
                ...
                <li>
                  <a href="http://localhost:3000/">Tracking</a>
                </li>
              </ul>
            </div>
            <div className="col-lg-2">
              ...
              <ul>
                ...
                <li>
                  <a href="http://localhost:3000/">Return Policy</a>
                </li>
                <li>
                  <a href="http://localhost:3000/">Product Registration</a>
                </li>
              </ul>
            </div>
